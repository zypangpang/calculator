...
void MainWindow::on_button_eraseAll_clicked()
{
    temp="";
    display="";
    s.empty();
...
void MainWindow::on_button_dsum_clicked()
{
    double Dsum;
    Dsum=s.DSum();
...
void MainWindow::on_button_svar_clicked()
{
    double svar;
    svar=s.StaVar();
...
void MainWindow::on_button_uvar_clicked()
{
    double uvar;
    uvar=s.UnVariance();
...
void MainWindow::on_button_var_clicked()
{
    double var;
    var=s.Variance();
...
void MainWindow::on_button_ave_clicked()
{
    double ave;
    ave=s.Average();
...
void MainWindow::on_button_rsort_clicked()
{
    display=s.rSort();
    ui->input->setText(display);
}
