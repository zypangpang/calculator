...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        button_space = new QPushButton(centralWidget);
        button_space->setObjectName(QStringLiteral("button_space"));
        button_space->setGeometry(QRect(10, 30, 71, 31));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        button_space->setText(QApplication::translate("MainWindow", "\347\251\272\346\240\274", 0));
